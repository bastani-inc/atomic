...
Draft fields must be text. If preparation reports `must be string`, supply the field as text in your next reply, then review the corrected draft. Do not rely on numbers or other values being converted automatically.
