...
| `prompt-engineer` | Write, migrate, or troubleshoot prompts for GPT-6 Astra, GPT-5.6, and current Claude models. | `/skill:prompt-engineer Draft a sharper repo-research prompt for payment retries end to end.` |
