# Workflow best practices and cookbook

Use these operational patterns, steering templates, gates, examples, and anti-patterns to turn a workflow graph into a reliable engineering process.
