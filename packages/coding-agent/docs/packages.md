...
Package-authored workflows should follow the same [guiding principles](/workflow-authoring#guiding-principles) and [context-engineering guidance](/workflow-context) as project workflows.
