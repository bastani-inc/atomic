...
### Fixed
- Updated the Z.AI and Z.AI Coding Plan defaults to the catalog-valid `glm-5.3` model and corrected the stale xAI default to `grok-4.5`; direct GLM-5.3 chains use `:high`, while OpenRouter and Baseten remain documented provider-specific exceptions because their catalogs do not expose GLM-5.3 ([#2459](https://github.com/bastani-inc/atomic/issues/2459)).
