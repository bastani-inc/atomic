...
- Documented the builtin `ralph` workflow's safe default for PR creation and the `create_pr=true` opt-in examples ([#1255](https://github.com/bastani-inc/atomic/issues/1255)).
