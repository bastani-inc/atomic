...
- Moved Atomic's streaming working indicator into the default editor border and matched its spinner and label to the thinking-level border color. Custom editors retain the standalone indicator unless they opt in to embedding it.
