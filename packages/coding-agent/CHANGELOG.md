...
- Fixed aggregate-large isolated-engine message events being rewritten as payload-less lifecycle records that crashed the interactive CLI; RPC output now remains structurally valid within the 1 MiB frame limit and reports irreducible overflow as a transport error ([#1985](https://github.com/bastani-inc/atomic/issues/1985)).
