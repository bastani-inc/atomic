...
- Capped Verbatim Compaction range-planner reasoning at `low` and added one bounded `minimal`-reasoning retry when a length-truncated plan contains no recoverable usable ranges.
