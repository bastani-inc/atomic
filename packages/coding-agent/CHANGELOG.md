...
- Changed the built-in xAI default and the shipped xAI and OpenRouter workflow and subagent fallback chains from Grok 4.5 to Grok 4.6. Benchmark docs keep Grok 4.5's measured result and mark Grok 4.6 as unmeasured rather than relabeling the old score.
