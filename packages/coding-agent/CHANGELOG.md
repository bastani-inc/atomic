...
- The managed `fd` download on macOS x64 is now pinned to 10.3.0, the last release that ships an Intel macOS binary ([#4559](https://github.com/earendil-works/pi/issues/4559)).
