...
/**
 * Custom message entry for extensions to inject messages into the visible transcript.
 * Use customType to identify your extension's entries.
 *
 * Unlike CustomEntry, this participates in LLM context unless excludeFromContext is true.
 * The content is converted to a user message in buildSessionContext()/convertToLlm().
...
export interface CustomMessageEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	display: boolean;
	/** If true, this message is display-only and skipped by LLM context/compaction. */
...
export class SessionManager {
	...
	/**
	 * Append a custom message entry (for extensions) that participates in LLM context by default.
	 * @param customType Extension identifier for filtering on reload
	 * @param content Message content (string or TextContent/ImageContent array)
	 * @param display Whether to show in TUI (true = styled display, false = hidden)
	 * @param details Optional extension-specific metadata (not sent to LLM)
	 * @param options.excludeFromContext If true, persist/display but skip LLM context and compaction.
	 * @returns Entry id
	 */
