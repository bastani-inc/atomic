...
- Strict current-turn user-image and live mixed MCP-result serialization remains supported for image-capable routes. Historical image blocks are omitted while historical text and tool continuity remain. Earlier-turn image reconstruction and structured clipboard attachments are deferred to issue #1807; assistant-generated images are outside this provider's scope.
