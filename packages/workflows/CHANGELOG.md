...
- Suppressed the benign `MCP OAuth initialization failed` startup line from workflow-visible error summaries while preserving the original diagnostic message.
