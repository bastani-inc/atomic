...
- Changed the builtin `ralph` prompt-engineering stage to disable all tools while relying on the `/prompt-engineer` skill prompt, keeping that first-pass rewrite focused and tool-free.
