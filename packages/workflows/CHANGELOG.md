...
### Removed
- Removed prescriptive post-launch workflow supervision and prompt-level orchestration resource-limit guidance from the default model prompt and repository release workflow messages.
