...
```json
{
  ...
  "parameters": {
    ...
    "runId": "optional full 36-character run UUID, exactly as displayed; control actions default to the active run where safe; use '--all' or all:true for pause/interrupt/quit all",
    "stageId": "optional exact stage id or exact stage/tool name; cannot be combined with all:true",
