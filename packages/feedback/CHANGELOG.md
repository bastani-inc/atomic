...
- Fixed direct-import feedback tool schemas accepting non-string draft fields through implicit conversion. Pass text for every field; validation errors identify fields to correct before preparing again ([#2799](https://github.com/bastani-inc/atomic/issues/2799)).
