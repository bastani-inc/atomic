/**
 * Build compiled-cli into a single self-contained binary.
 *
 * Output: `./dist/compiled-cli` (or `.exe` on Windows). The entire workflow
...
const exeName = process.platform === "win32" ? "compiled-cli.exe" : "compiled-cli";
