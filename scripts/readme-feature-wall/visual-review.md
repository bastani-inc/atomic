...
| 6.6 | The audit finds two blockers, the human answers yes, `repair-1` runs, and the graph reaches 4/4. | Audit, confirm, repair, and terminal graph state are readable. | Pass |
