...
- Initial release of `@bastani/atomic-workflows`, a raw TypeScript pi package for multi-stage workflow authoring and execution.
...
- `/workflows-doctor` diagnostics command for workflow discovery, configuration, runtime capability, and companion-package status.
...
- Workflow discovery from bundled workflows, project-local `.pi/workflows/`, user-global `~/.pi/agent/workflows/`, and configured workflow directories.
